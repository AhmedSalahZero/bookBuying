                          ...
                          @foreach($items as $item)
                              <tr class="cart_item">
                                  ...
                                  <td class="product-subtotal">
                                      <h5 class="total amount">$
                                          ...
                                          {{number_format($item->quantity * $item->price)}}</h5>
                                  </td>
                              ...
                              @endforeach
                                    ...
                                    <tr class="cart_item total">
                                        ...
                                        <td class="product-subtotal">
                                            <h5 class="total amount">${{number_format(\Cart::session(Auth()->user()->id)->getTotal())}} </h5>
                                        </td>
                                    </tr>
								...
								<form action="{{Route('cart.checkout')}}" method="POST">
                                    @csrf
									  <script
                                          ...
                                          data-key="pk_test_i1vO8QResjSs8tDeSH72ajVb00Sp82eqKU"
                                          data-amount="{{\Cart::session(Auth()->user()->id)->getTotal()*100}}"
                                          data-name="conan.com"
                                          data-description="write here a description "
