...
<head lang="en">
    ...
    <link rel="stylesheet" herf="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css">
                ...
                <li class="cart">
                    ...
                    <div class="cart-popup-wrap">
                        <div class="popup-cart">
                            <h4 class="title-cart align-center">@if(Auth()->user())
